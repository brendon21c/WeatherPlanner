...
// This class was generated using http://pojo.sodhanalibrary.com/Convert.
...
public class WeatherConditions {
    ...
    class Display_location
    {
        ...
        public String toString()
        {
            return "ClassPojo [zip = "+zip+", full = "+full+", elevation = "+elevation+", state = "+state+", longitude = "+longitude+", latitude = "+latitude+", state_name = "+state_name+", country_iso3166 = "+country_iso3166+", country = "+country+", city = "+city+"]";
        }
    }
